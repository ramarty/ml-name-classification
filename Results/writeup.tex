...
\input{tables/religion_results_test.tex}
%\end{adjustbox}
\end{table}
...
\centering
%\begin{adjustbox}{width=1\textwidth}
\input{tables/religion_results_train.tex}
%\end{adjustbox}
\end{table}
...
\centering
\begin{adjustbox}{width=1\textwidth}
\input{tables/d1_results_test.tex}
\end{adjustbox}
\end{table}
...
\centering
\begin{adjustbox}{width=1\textwidth}
\input{tables/d1_results_train.tex}
\end{adjustbox}
\end{table}
...
\centering
\begin{adjustbox}{width=1\textwidth}
\input{tables/d3_results_test.tex}
\end{adjustbox}
\end{table}
...
\centering
\begin{adjustbox}{width=1\textwidth}
\input{tables/d3_results_train.tex}
\end{adjustbox}
\end{table}
...
\centering
\begin{adjustbox}{width=1\textwidth}
\input{tables/d5_results_test.tex}
\end{adjustbox}
\end{table}
...
\centering
\begin{adjustbox}{width=1\textwidth}
\input{tables/d5_results_train.tex}
\end{adjustbox}
\end{table}
...
\centering
\begin{adjustbox}{width=1\textwidth}
\input{tables/d7_results_test.tex}
\end{adjustbox}
\end{table}
...
\centering
\begin{adjustbox}{width=1\textwidth}
\input{tables/d7_results_train.tex}
\end{adjustbox}
\end{table}
...
\centering
\begin{adjustbox}{width=1\textwidth}
\input{tables/d10_results_test.tex}
\end{adjustbox}
\end{table}
...
\centering
\begin{adjustbox}{width=1\textwidth}
\input{tables/d10_results_train.tex}
\end{adjustbox}
\end{table}
