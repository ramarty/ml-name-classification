...
# Filepaths --------------------------------------------------------------------
if(Sys.info()["user"] == "WB521633") project_file_path <- "C:/Users/wb521633/Dropbox/World Bank/Side Work/ml-name-classification"
if(Sys.info()["user"] == "robmarty") project_file_path <- "~/Dropbox/World Bank/Side Work/ml-name-classification"
